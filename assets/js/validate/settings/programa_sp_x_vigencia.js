$( document ).ready( function () {
	...
	$( "#form" ).validate( {
		rules: {
			...
			recurso_programado_programa:			{ required: true, minlength: 1, maxlength: 15 }
		},
		errorElement: "em",
	...
	$("#btnSubmit").click(function(){		
		...
		if ($("#form").valid() == true){
				...
				$.ajax({
					type: "POST",	
					url: base_url + "settings/save_programa_sp_x_vigencia",	
					data: $("#form").serialize(),
					dataType: "json",
					...
					success: function(data){
						...
						{	                                                        
							...
							var url = base_url + "settings/programa_sp_x_vigencia";
							$(location).attr("href", url);
						}
						else
						{
