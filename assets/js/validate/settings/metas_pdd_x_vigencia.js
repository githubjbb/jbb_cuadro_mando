$( document ).ready( function () {
	...
	$( "#form" ).validate( {
		rules: {
			metaPDD:								{ required: true },
			vigencia:								{ required: true },
			recurso_programado_meta_pdd:			{ required: true, minlength: 1, maxlength: 15 }
		},
		errorElement: "em",
	...
	$("#btnSubmit").click(function(){		
		...
		if ($("#form").valid() == true){
				...
				$.ajax({
					type: "POST",	
					url: base_url + "settings/save_metas_pdd_x_vigencia",	
					data: $("#form").serialize(),
					dataType: "json",
					...
					success: function(data){
						...
						{	                                                        
							...
							var url = base_url + "settings/metas_pdd_x_vigencia";
							$(location).attr("href", url);
						}
						else
						{
