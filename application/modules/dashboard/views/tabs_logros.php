        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="fa fa-bell fa-fw"></i> Avance Logros <b><?php echo $vigencia['vigencia']; ?></b><br>
                ...
                <div class="panel-body small">
                    <table class="table table-hover">
                        ...
                        <?php
                        foreach ($listaLogros as $lista):
                            $arrParam = array(
                                "numeroLogro" => $lista["numero_logro"],
                            ...
                            echo "<tr>";
                            echo "<td><small>" . $lista["numero_logro"] .' ' . $lista["logro"] . "</small></td>";
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body small">
                    <table class="table table-hover">
                        ...
                        <?php
                        foreach ($listaProyectosLogros as $lista):
                            $arrParam = array(
                                "numeroLogro" => $lista["fk_numero_logro"],
                                "numeroProyecto" => $lista["fk_numero_proyecto"],
                                "vigencia" => $vigencia['vigencia']
                            );
                            $infoProyectos = $this->general_model->infoLogros($arrParam);
                            $arrParam = array(
                                "numeroLogro" => $lista["fk_numero_logro"],
                                "vigencia" => $vigencia['vigencia']
                            );
                            $sumLogros = $this->general_model->sumatoriaItem($arrParam);
                            $suma = 0;
                            for ($i=0; $i<count($infoProyectos); $i++) {
                                $infoProyectos[$i]['avance1'] = round($infoProyectos[$i]['presupuesto_meta'] / $sumLogros['presupuesto_meta'], 4);
                            ...
                            echo "<tr>";
                            echo "<td><small>" . $infoProyectos[0]["numero_logro"] .' ' . $infoProyectos[0]["logro"] . "</small></td>";
