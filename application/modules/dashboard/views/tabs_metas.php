        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="fa fa-bell fa-fw"></i> Avance Metas <b><?php echo $vigencia['vigencia']; ?></b><br>
                ...
                <div class="panel-body small">
                    <table class="table table-hover">
                        ...
                        <?php
                        foreach ($listaMetaPDD as $lista):
                            $arrParam = array(
                                "numeroMetaPDD" => $lista["numero_meta_pdd"],
                ...
                <div class="panel-body small">
                    <table class="table table-hover">
                        ...
                        foreach ($listaMetaPDD as $lista):
                            ...
                            $avance = $this->general_model->get_metas_pdd_x_vigencia($arrParam);
                            $arrParam = array(
                                'numeroMetaPDD' => $lista['numero_meta_pdd'],
                                'vigencia' => $vigencia['vigencia']
                            );
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body small">
                    <table class="table table-hover">
                        ...
                        <?php
                        foreach ($listaProyectosMetasPDD as $lista):
                            $arrParam = array(
                                "numeroMetaPDD" => $lista["fk_numero_meta_pdd"],
                                "numeroProyecto" => $lista["fk_numero_proyecto"],
                                "vigencia" => $vigencia['vigencia']
                            );
                            $infoProyectos = $this->general_model->infoMetasPDD($arrParam);
                            $arrParam = array(
                                "numeroProyecto" => $lista["fk_numero_proyecto"],
                                "vigencia" => $vigencia['vigencia']
                            );
                            $sumMetas = $this->general_model->sumatoriaItem($arrParam);
                            $suma = 0;
                            for ($i=0; $i<count($infoProyectos); $i++) {
                                $infoProyectos[$i]['avance1'] = round($infoProyectos[$i]['presupuesto_meta'] / $sumMetas['presupuesto_meta'], 4);
                            ...
                            echo "<tr>";
                            echo "<td><small>" . $infoProyectos[0]["numero_meta_pdd"] .' ' . $infoProyectos[0]["meta_pdd"] . "</small></td>";
